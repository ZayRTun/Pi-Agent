...
export function getSelectListTheme() {
    return {
        ...
        argumentHint: (text) => theme.fg("mdCode", text),
        sourceTag: (text) => theme.fg("dim", text),
...
export function getEditorTheme() {
    return {
        ...
        // Prime Agent TUI: dark surface block editor + popover panel + slash accent.
        backgroundColor: (text) => theme.bg("userMessageBg", text),
        autocompleteBackgroundColor: (text) => theme.bg("customMessageBg", text),
